  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm overflow-hidden relative">
      ...
      <div className="p-4">
        ...
        <button
          onClick={onDelete}
          className="w-full py-2 px-4 border-2 border-green-600 text-green-600 rounded-lg font-medium hover:bg-green-50 transition-colors flex items-center justify-center gap-2"
        >
